...
from day04.frontend_testcases.utils import identify_code_img, load_cookies, sava_cookies, is_login
...
if not is_login(driver):
    ...
    # 反例
    # driver.find_element(By.XPATH, '//*[@id="login-password"]').send_keys("1234")

    # 获取验证码图片
    sleep(1)
    driver.find_element(By.XPATH, '//*[@id="Jverify_img"]').screenshot("code_img.png")
    # ○ 输入验证码
